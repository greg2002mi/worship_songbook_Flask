        ...
        for line in lines:
            ...
            if not line:
                ...
                if re.search(r'\[[^\]]+\]', line): # yes
                    ...
                    html_segments = []
                    html_segments.append('<div class="col-auto"><div class="chordpro_segment"><span class="ChordContainer"><span class="Chord"></span><span class="suffix">&nbsp;</span></span></div>') #open div
